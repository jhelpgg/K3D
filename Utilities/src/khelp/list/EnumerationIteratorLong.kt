 ...
 */
class EnumerationIteratorLong : Iterable<Long>, Enumeration<Long>, Iterator<Long>
{
    /**
     * Embed array
     */
     ...
     * Embed enumeration
     */
    private val enumeration: Enumeration<Long>?
    /**
     * Read index in array
     */
     ...
     * Embed iterator
     */
    private val iterator: Iterator<Long>?

    /**
     * Create enumeration/iterator based on enumeration
     */
    constructor(enumeration: Enumeration<Long>)
    {
        this.array = null
     ...
     */
    constructor(iterator: Iterator<Long>)
    {
        this.array = null
